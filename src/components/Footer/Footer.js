                ...
                <div className="container">
                    <div className="row ml-4 pl-4">
                        ...
                        <div className="col-md-4 col-sm-12 mb-4 ">
                            <h5><b>Contact</b></h5>
                            <ul className="list-unstyled">
                                <li><a className="text-light"><a href="https://wa.me/8669881059" > <img src='\img\email-logo.png' className='footer-img-height'></img></a>   saishubhamtours8994@gmail.com</a></li>
